...
/*
	Creates all necessary shaders and handles them
*/
class ShaderManager
{
public:
...
private:
	std::map<int, unsigned int> programs; //All shader programs
	unsigned int currentProgram; //Stores current program
	Utils::ShaderType currentType = Utils::SHADER_3D; //Stores type of the current shaders
};
